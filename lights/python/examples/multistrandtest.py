...
LED_1_PIN        = 17      # GPIO pin connected to the pixels (must support PWM! GPIO 13 and 18 on RPi 3).
...
LED_2_PIN        = 22      # GPIO pin connected to the pixels (must support PWM! GPIO 13 or 18 on RPi 3).
